...
export default function ViewTeamStats({
  ...
  return (
    <Drawer anchor="right" open={open} onClose={handleClose} width={"400px"}>
      <Box width={"660px"}>
        <Box
          width={"100%"}
          display={"flex"}
        ...
        <Box padding={"5%"}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <Text24 color={PrimaryColors.Black}>{teamFullName}</Text24>
            </Grid>
            <Grid item xs={6}>
              <Text24 color={PrimaryColors.Black}>Total Games played</Text24>
            </Grid>
            <Grid item xs={6}>
              <Text24 color={PrimaryColors.Black}>{totalGames}</Text24>
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>{date?.slice(0, 10)}</Bold24>
            </Grid>
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>Home Team</Bold24>
            </Grid>
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>{homeTeamName}</Bold24>
            </Grid>
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>Home Team Score</Bold24>
            </Grid>
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>{homeTeamScore}</Bold24>
            </Grid>
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>Visitor Team</Bold24>
            </Grid>
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>{awayTeamName}</Bold24>
            </Grid>
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>Visitor Team Score</Bold24>
            </Grid>
            <Grid item xs={6}>
              <Bold24 color={PrimaryColors.Black}>{awayTeamScore}</Bold24>
            </Grid>
          </Grid>
        </Box>
      </Box>
